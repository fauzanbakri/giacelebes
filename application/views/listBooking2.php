                                                ...
                                                <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded" id="pills-tab" role="tablist">
                                                    <?php   
                                                        if ($_SESSION['role']==3) {
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link rounded active" href="listBooking2">
                                                                    <div class="text-center py-2">
                                        ...
                                        <div class="row pt-2">
                                            <div class="col-12">
                                                <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <div class="tab-pane active fade show" id="pills-smart" role="tabpanel" aria-labelledby="pills-smart-tab">
                                                    <a href="jetty2" <?php if($_SESSION['role']!=3){echo "hidden";} ?> class="btn btn-primary btn-sm mb-3">Input Jetty 2</a>
                                                          ...
                                                          <table id="example2" class="table table-bordered table-striped">
                                                            ...
                                                            {  
                                                               ...
                                                               <td><?php 
                                                                    ...
                                                                    ?></td>
                                                               <td><center><button id="edit2" class="btn btn-icon btn-primary"><i data-feather="edit-3" class="fea icon-sm"></i></button>&nbsp;<button id="delete2" class="btn btn-icon btn-danger"><i data-feather="trash" class="fea icon-sm"></i></button></center></td>  
                                                               </tr>  
                                                            <?php }  
                                                            ?>
                                                            </tbody>
                                                    ...
                                                    <div class="tab-pane active fade" id="pills-apps" role="tabpanel" aria-labelledby="pills-apps-tab">
                                                            ...
                                                            {  
                                                               ...
                                                               <td><?php 
                                                                    if($row->status==0){
                                                                      ...
                                                                      echo '<span class="badge bg-info"> Anchored </span>';
                                                                    }else {
                                                                      echo '<span class="badge bg-dark"> Incoming </span>';
                                                                    }
                                                                    ?></td>
