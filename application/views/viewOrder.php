                    ...
                    <div class="col-lg-12 col-md-7">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            {  
                               ...
                               <td><?php echo $row->nominasi; ?></td>
                               <td><?php echo $row->loading_order_date; ?></td>
                               <td><center><a href="<?php echo $row->dokumen; ?>" id="edit1" class="btn btn-icon btn-primary"><i data-feather="download" class="fea icon-sm"></i></a>&nbsp;<button id="delete1" class="btn btn-icon btn-danger"><i data-feather="trash" class="fea icon-sm"></i></button></center></td>  
                               </tr>  
                            <?php }  
                            ?>
                            </tbody>
...
<script type="text/javascript">
        $('#deletejetty1').on('click', function () {
            var id = $('#jetty1id').val();
            $("#deletejetty1").prop("href", "ViewOrder/delete?id="+id)
        });
