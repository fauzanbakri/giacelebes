...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-170 bg-primary d-table w-100" style="background-image: url('images/job/bg2.jpeg');">
            <div class="container">
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <!-- <h2 class="title text-white title-dark mb-0"> Edit Jetty 2 </h4> -->
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                ...
                <div class="position-breadcrumb">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                            <li class="breadcrumb-item active" aria-current="page">Edit Vessel Jetty 2</li>
                        </ul>
                    </nav>
                </div>
            </div> <!--end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="jetty2_edit/edit" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                       ...
                                       <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="etc" value="<?php echo $row['etc']; ?>" id="end" type="text" class=" form-control ps-5 example" placeholder="Estimation Time Completed (ETC) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="etd" value="<?php echo $row['etd']; ?>" id="end" onkeydown="return false" type="text" class=" form-control ps-5 example" placeholder="Estimation Time Departure (ETD) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="remarks" value="<?php echo $row['remarks']; ?>" id="email2" type="text" class="form-control ps-5" placeholder="Remarks :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select required name="status" class="form-control form-select" id="jam">
                                                    <option <?php if($row['status']==4){echo "selected";}; ?> value="4">Departure</option>
                                                    <option <?php if($row['status']==5){echo "selected";}; ?> value="5">Departure</option>
                                                    <option <?php if($row['status']==2){echo "selected";}; ?> value="2">Anchored</option>
                                                    <option <?php if($row['status']==1){echo "selected";}; ?> value="1">At Jetty</option>
                                                    <option <?php if($row['status']==3){echo "selected";}; ?> value="3">Selesai</option>
                                                </select>
                                            </div>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo $row['id_jetty']; ?>">
                                    <div class="row">
                                        <div class="col-sm-12">
