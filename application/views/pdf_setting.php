    ...
    <body>
        ...
        <ul class="nav nav-tabs">
          ...
          if ($_SESSION['role']==3){
            ...
            <li class="nav-item">
            <a class="nav-link active" href="Pdf_setting">PDF Setting</a>
            </li>
            ';
          }
          ?>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="Pdf_setting/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="pass" required id="name2" type="text" class="form-control ps-5" placeholder="Password :">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="submit" id="submit" name="submit" class="submitBnt btn btn-primary" value="Change">
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </form><!--end form-->
                            </div> 
