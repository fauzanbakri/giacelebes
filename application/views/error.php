...
<!-- Mirrored from shreethemes.in/landrick/layouts/page-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jul 2021 09:14:39 GMT -->
<head>
        <meta charset="utf-8" />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">  
                        <a href="home" class="btn btn-primary mt-4 ms-2">Go To Home</a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
