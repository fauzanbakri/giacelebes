...
<head>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded" id="pills-tab" role="tablist">
                                                    ...
                                                    ?>
                                                    <li class="nav-item">
                                                        <a class="nav-link rounded" href="listBooking3">
                                                            <div class="text-center py-2">
                                                    ...
                                                    <?php   
                                                        if ($_SESSION['role']==3) {
                                                            echo '
                                                            <li class="nav-item">
                                                                <a class="nav-link rounded active" href="listBooking4">
                                                                    <div class="text-center py-2">
                                        ...
                                        <div class="row pt-2">
                                            <div class="col-12">
                                                <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <a href="NextBerth" <?php if($_SESSION['role']!=3){echo "hidden";} ?> class="btn btn-primary btn-sm mb-3">Input Vessel Activity</a>
                                                        <?php if($_SESSION['role']!=3){echo "Only Super Admin can see this";} ?>
                                                        <div <?php if($_SESSION['role']!=3){echo "hidden";} ?>>
                                                          <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tr>
                                                              ...
                                                              <th>Remarks</th>
                                                              <th>Status</th>
                                                              <th>Berthing Plan Jetty 1</th>
                                                              <th>Berthing Plan Jetty 2</th>
                                                              <th>Action</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <?php  
                                                            foreach ($berth->result() as $row)  
                                                            {  
                                                               ?>
                                                               <tr>
                                                               ...
                                                               <td><?php 
                                                                    if($row->status==0){
                                                                        ...
                                                                        echo '<span style="font-size:11px;"><b>Undetermined</b></span>';
                                                                    }
                                                                    ?></td>
                                                               <td><center>
                                                               <button id="mv_jetty1" class="badge btn-xs btn-success">Jetty 1</button>
                                                               </center></td>
                                                               <td>
                                                               <center><button id="mv_jetty2" class="badge btn-sm btn-success">Jetty 2</button></center>
                                                               </td>
                                                               <td><center><button id="edit1" class="btn btn-icon btn-primary"><i data-feather="edit-3" class="fea icon-sm"></i></button><button id="delete1" class="btn btn-icon btn-danger"><i data-feather="trash" class="fea icon-sm"></i></button></center></td>  
                                                               </tr>  
                                                            <?php }  
                                                            ?>
                                                            </tbody>
    ...
    $('#example1 tbody').on('click', '#edit1', function () {
        ...
        var nmr = data[0];
        window.location.href='Nextberth_edit?id='+nmr;
    ...
    $('#example1 tbody').on('click', '#mv_jetty1', function () {
        var data = table.row( $(this).parents('tr') ).data();
        var nmr = data[0];
        // alert("Jetty 1");
        window.location.href='ListBooking4/move1?id='+nmr;
    });
     $('#example1 tbody').on('click', '#mv_jetty2', function () {
        var data = table.row( $(this).parents('tr') ).data();
        var nmr = data[0];
        // alert("Jetty 2");
        window.location.href='ListBooking4/move2?id='+nmr;
    });
...
<script type="text/javascript">
        $('#deletejetty1').on('click', function () {
            var id = $('#jetty1id').val();
            $("#deletejetty1").prop("href", "listBooking4/delete1?id="+id)
        });
</script>
    </body>
