...
<head>
        <meta charset="utf-8" />
        <title>Vessel Activity Edit Data</title>
    ...
    <body>
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <!-- <h2 class="title text-white title-dark mb-0"> Edit Vessel Activity </h4> -->
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                ...
                <div class="position-breadcrumb">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                            <li class="breadcrumb-item active" aria-current="page">Edit Vessel Activity</li>
                        </ul>
                    </nav>
                </div>
            </div> <!--end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="Nextberth_edit/edit" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">Status :<span class="text-danger">*</span></label>
                                                <select required name="status" class="form-control form-select" id="state">
                                                    <option <?php if($row['status']==4){echo "selected";}; ?> value="0">Undetermined</option>
                                                    <option <?php if($row['status']==3){echo "selected";}; ?> value="3">Departure</option>
                                                    <option <?php if($row['status']==2){echo "selected";}; ?> value="2">Incoming</option>
                                                    <option <?php if($row['status']==0){echo "selected";}; ?> value="0">Anchored</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="namakapal" value="<?php echo $row['nama_kapal']; ?>" required id="name2" type="text" class="form-control ps-5" placeholder="Nama Kapal :">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-12" id="LP">
                                            <div class="mb-3">
                                                <label class="form-label">Last Port :</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="anchor" class="fea icon-sm icons"></i>
                                                    <input name="lastport" value="<?php echo $row['last_port']; ?>" id="name2" type="text" class="form-control ps-5" placeholder="Last Port :">
                                                </div>
                                            </div>
                                        </div>
                                       <div class="col-md-12" id="ATA">
                                            <div class="mb-3">
                                                <label class="form-label">Actual Time of Arrival (ATA) :</label>
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="ata" value="<?php echo $row['ATA']; ?>" id="start" type="text" class=" form-control ps-5 example" placeholder="Actual Time of Arrival (ATA) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12" id="ETA">
                                            <div class="mb-3">
                                                <label class="form-label">Estimate Time of Arrival (ETA) :</label>
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="eta" value="<?php echo $row['ETA']; ?>" id="start" type="text" class=" form-control ps-5 example" placeholder="Estimate Time of Arrival (ETA) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <!-- <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="berthed" value="<?php echo $row['berthed']; ?>" id="end" type="text" class=" form-control ps-5 example" placeholder="Berthed :">
                                                </div>
                                            </div> 
                                        </div>end col -->
                                        <div class="col-md-12" id="ATD">
                                            <div class="mb-3">
                                                <label class="form-label">Actual Time of Departure (ATD) :</label>
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="atd" value="<?php echo $row['ATD']; ?>" id="start" type="text" class=" form-control ps-5 example" placeholder="Actual Time of Departure (ATD) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="cargo" value="<?php echo $row['cargo']; ?>" type="text" class="form-control ps-5" placeholder="Cargo :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-12" id="BK">
                                            <div class="mb-3">
                                                <label class="form-label">Bunker :</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="database" class="fea icon-sm icons"></i>
                                                    <input name="bunker" value="<?php echo $row['bunker']; ?>" type="text" class="form-control ps-5" placeholder="Bunker :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-12" id="NP">
                                            <div class="mb-3">
                                                <label class="form-label">Next Port :</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="compass" class="fea icon-sm icons"></i>
                                                    <input name="next" id="email2" value="<?php echo $row['next_port']; ?>" type="text" class="form-control ps-5" placeholder="Next Port :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                      <!--  -->
                                        <div class="col-md-12" id="etanext">
                                            <div class="mb-3">
                                                <label class="form-label">ETA Next Port :</label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="compass" class="fea icon-sm icons"></i>
                                                    <input name="etanext" id="email2" value="<?php echo $row['eta_next']; ?>" type="text" class="form-control ps-5 example" placeholder="ETA Next Port :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                       <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="remarks" id="email2" value="<?php echo $row['remarks']; ?>" type="text" class="form-control ps-5" placeholder="Remarks :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
        ...
        function cekstat(){
            var stat = $('#state').val();
             if (stat==0) {
             // console.log(stat);
                $('#ATD').attr("hidden",true);
                $('#ATD').attr("disabled",true);
                $('#ETA').attr("hidden",true);
                $('#ETA').attr("disabled",true); 
                $('#etanext').attr("hidden",true);
                $('#etanext').attr("disabled",true);
                $('#NP').removeAttr("disabled");
                $('#NP').removeAttr("hidden");
                $('#LP').removeAttr("disabled");
                $('#LP').removeAttr("hidden"); 
                $('#BK').removeAttr("disabled");
                $('#BK').removeAttr("hidden"); 
                $('#ATA').removeAttr("disabled");
                $('#ATA').removeAttr("hidden");   
             }else if(stat==2){
                $('#ATD').attr("hidden",true);
                $('#ATD').attr("disabled",true);
                $('#ATA').attr("hidden",true);
                ...
                $('#etanext').removeAttr("disabled");
                $('#etanext').removeAttr("hidden"); 
                $('#ATD').removeAttr("disabled");
                $('#ATD').removeAttr("hidden"); 
