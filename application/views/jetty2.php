                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <!-- <h2 class="title text-white title-dark mb-0"> Jetty 2 </h4> -->
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                ...
                <div class="position-breadcrumb">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                            <li class="breadcrumb-item active" aria-current="page">Vessel Register Jetty 2</li>
                        </ul>
                    </nav>
                </div>
            </div> <!--end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="jetty2/submit" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                       ...
                                       <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="berthed" id="end" onkeydown="return false" type="text" class=" form-control ps-5 example" placeholder="Berthed :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-12">
