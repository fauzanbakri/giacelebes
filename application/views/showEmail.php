                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <h2 class="title text-white title-dark mb-0"> Registere Email </h4>
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="row">
                                        ...
                                        <div class="row pt-2">
                                            <div class="col-12">
                                            <a href="addEmail" <?php if($_SESSION['role']!=3){echo "hidden";} ?> class="btn btn-primary btn-sm mb-3">Add Email</a>
                                                        ...
                                                        <div <?php if($_SESSION['role']!=3){echo "hidden";} ?>>
                                                          <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            {  
                                                               ...
                                                               <td><center></button><button id="delete1" class="btn btn-icon btn-danger"><i data-feather="trash" class="fea icon-sm"></i></button></center></td>  
                                                               </tr>  
                                                            <?php }  
                                                            ?>
                                                            </tbody>
...
<script type="text/javascript">
        $('#deletejetty1').on('click', function () {
            var id = $('#jetty1id').val();
            $("#deletejetty1").prop("href", "showEmail/delete1?id="+id)
        });
