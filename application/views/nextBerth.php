                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="nextBerth/submit" method="post" enctype="multipart/form-data">
                                    <center><h5 class="text-primary">Vessel Activity Input</h5></center><br><br>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select required name="status" class="form-control form-select" id="state">
                                                    ...
                                                    <option value="0">Anchored</option>
                                                    <option value="3">Departure</option>
                                                    <!-- <option value="1">Clearance Only</option> -->
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                       ...
                                       <div class="col-md-12" id="ATA">
                                        ...
                                        <div class="col-md-12" id="ETA">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="eta" id="start1" onkeydown="return false" type="text" class=" form-control ps-5 example" placeholder="Estimated Time of Arrival (ETA) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12" id="ATD">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="atd" id="start2" onkeydown="return false" type="text" class=" form-control ps-5 example" placeholder="Actual Time of Departure (ATD) :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12" id="etanext">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative md-form md-outline">
                                                    <i data-feather="calendar" class="fea icon-sm icons"></i>
                                                    <input name="etanext" id="start2" onkeydown="return false" type="text" class=" form-control ps-5 example" placeholder="Actual Time of Arrival (ATA) :">
                                                </div>
                                            </div> 
                                        </div>
