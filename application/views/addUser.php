                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <h2 class="title text-white title-dark mb-0"> Add User </h4>
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                    ...
                    <div class="row">
                                            <div class="col-lg-12">
                                                <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded" id="pills-tab" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link rounded active" href="addUser">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link rounded" href="showEmail">
                                                            <div class="text-center py-2">
                        ...
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="AddUser/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="nama" required id="name2" type="text" class="form-control ps-5" placeholder="Nama :">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="email" type="text" class="form-control ps-5" placeholder="Email :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="username" required id="username" type="text" class="form-control ps-5" placeholder="Username :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <button type="button" onclick="showUser()" class="btn btn-primary">Show User</button>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </form><!--end form-->
                            </div> 
...
<script type="text/javascript">
        ...
        $('#deletejetty1').on('click', function () {
            var id = $('#jetty1id').val();
            $("#deletejetty1").prop("href", "ShowUser/delete1?id="+id)
        });
