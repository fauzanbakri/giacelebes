                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <!-- <h2 class="title text-white title-dark mb-0"> Edit Jetty 1 </h4> -->
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                ...
                <div class="position-breadcrumb">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                            <li class="breadcrumb-item active" aria-current="page">Edit Vessel Jetty 1</li>
                        </ul>
                    </nav>
                </div>
            </div> <!--end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="jetty1_edit/edit" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select required name="status" class="form-control form-select" id="jam">
                                                    <option <?php if($row['status']==4){echo "selected";}; ?> value="4">Incoming</option>
