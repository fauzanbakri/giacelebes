                                                    ...
                                                    <?php   
                                                        ...
                                                        if ($_SESSION['role']==3) {
                                                            ...
                                                            <li class="nav-item">
                                                                ...
                                                                <a class="nav-link rounded active" href="listBooking">
                                        ...
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <a href="jetty1" <?php if($_SESSION['role']!=3){echo "hidden";} ?> class="btn btn-primary btn-sm mb-3">Input Jetty 1</a>
