                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="pages-heading">
                            <h2 class="title text-white title-dark mb-0"> Edit User </h4>
                        </div>
                    </div>  <!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-7">
                        <div class="card custom-form border-0">
                            <div class="card-body">
                                <form class="rounded shadow p-4" action="EditUser/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="nama" required id="name2" type="text" class="form-control ps-5" value="<?php echo $data['name']; ?>" placeholder="Nama :">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="email" required type="text" class="form-control ps-5" value="<?php echo $data['email']; ?>" placeholder="Email :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user" class="fea icon-sm icons"></i>
                                                    <input name="username" required id="username" type="text" class="form-control ps-5" value="<?php echo $data['username']; ?>" placeholder="Username :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="password" required type="text" class="form-control ps-5" placeholder="Password :">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select required name="role" class="form-control form-select" id="Sortbylist-Shop">
                                                    <option <?php if($data['role']==0){echo 'selected';}?> value="0">Guest 1</option>
                                                    <option <?php if($data['role']==1){echo 'selected';}?> value="1">Guest 2</option>
                                                    <option <?php if($data['role']==4){echo 'selected';}?> value="4">Admin 1</option>
                                                    <option <?php if($data['role']==2){echo 'selected';}?> value="2">Admin 2</option>
                                                    <option <?php if($data['role']==3){echo 'selected';}?> value="3">Super Admin</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="submit" id="submit" name="submit" class="submitBnt btn btn-primary" value="Edit">
                                            <a type="button" href="showUser" class="submitBnt btn btn-secondary">Cancel</a>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </form><!--end form-->
                            </div> 
