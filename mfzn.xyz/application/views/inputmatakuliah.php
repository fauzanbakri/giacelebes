...
<h1 class="mb-0 pb-0 display-4">Input Mata Kuliah</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="InputMataKuliah/input" method="post">
<div class="col-md-12">
...
<input id="matakuliah" name="matakuliah" class="form-control">
</div>
<div class="col-12">
