...
<h1 class="mb-0 pb-0 display-4">Edit Mata Kuliah</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="EditMatakuliah/input" method="post">
<div class="col-md-12">
<label for="inputState" class="form-label">Jurusan</label>
<select id="jurusan" name="jurusan" class="form-select">
<?php echo '<option selected value="'.$value["id_jurusan"].'">'.$value["nama_jurusan"].' (Current)</option>'; ?>
<?php 
...
<input name="matakuliah" value="<?php echo $value['nama_mk']; ?>" class="form-control">
