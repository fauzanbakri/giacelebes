...
<h1 class="mb-0 pb-0 display-4" id="title">Jadwal</h1>
...
<td class="text-muted text-small text-uppercase">Dosen</td>
<td class="text-muted text-small text-uppercase">Hari</td>
<td class="text-muted text-small text-uppercase">Mulai</td>
<td class="text-muted text-small text-uppercase">Selesai</td>
