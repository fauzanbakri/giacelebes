...
<h1 class="mb-0 pb-0 display-4">Edit Kelas</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="EditKelas/input" method="post">
<div class="col-md-12">
...
<input name="kelas" value="<?php echo $value['nama_kelas']; ?>" class="form-control">
