...
<h1 class="mb-0 pb-0 display-4">Input Ruangan</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="InputRuangan/input" method="post">
<div class="col-md-12">
<label for="inputState" class="form-label">Nama Ruangan</label>
<input id="nama" name="nama" class="form-control">
</div>
<div class="col-md-12">
<label for="inputState" class="form-label">MAC Address Access Point</label>
