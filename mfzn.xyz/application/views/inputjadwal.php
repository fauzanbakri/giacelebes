...
<h1 class="mb-0 pb-0 display-4">Input Jadwal</h1>
...
<div class="card mb-5">
<div class="card-body">
<form method="post" action="InputJadwal/input" class="row g-3">
<div class="col-md-12">
...
<input required type="text" name="mulai" class="example form-control">
</div>
<div class="col-md-12">
<label class="form-label">Jam Selesai</label>
<input required name="selesai" type="text" class="example form-control">
</div>
<div class="col-12">
