...
<h1 class="mb-0 pb-0 display-4" id="title">Data Mahasiswa</h1>
...
<td class="text-muted text-small text-uppercase">Program Studi</td>
<td class="text-muted text-small text-uppercase">Kelas</td>
<td class="text-muted text-small text-uppercase">NIM</td>
...
$(document).ready(function() {
    ...
    $('#example tbody').on('click', '#edit1', function () {
        ...
        var nmr = data[0];
        window.location.href='EditMahasiswa?id='+nmr;
    ...
    $('#deletejetty1').on('click', function () {
	    var id = $('#jetty1id').val();
	    $("#deletejetty1").prop("href", "DataMahasiswa/delete?id="+id)
	});
} );
</script>
</body>
