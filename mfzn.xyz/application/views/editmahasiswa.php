...
<h1 class="mb-0 pb-0 display-4">Edit Mahasiswa</h1>
...
<div class="card mb-5">
<div class="card-body">
<form method="post" action="EditMahasiswa/input" class="row g-3">
<div class="col-md-12">
...
<input required name="nama" type="text" class="form-control" value="<?php echo $value["nama"];?>">
<input required name="id" type="hidden" class="form-control" value="<?php echo $id;?>">
</div>
<div class="col-md-12">
<label class="form-label">NIM</label>
<input required name="nim" type="text" class="form-control" value="<?php echo $value["nim"];?>">
</div>
<div class="col-md-12">
<label class="form-label">Password</label>
<input required name="password" type="password" class="form-control" value="<?php echo $value["password"];?>">
</div>
<div class="col-12">
