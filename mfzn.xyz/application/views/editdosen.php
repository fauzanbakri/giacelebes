...
<h1 class="mb-0 pb-0 display-4">Edit Dosen</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="EditDosen/input" method="post">
<div class="col-md-12">
<label for="inputState" class="form-label">Nama</label>
<input id="nama" value="<?php echo $row['nama']; ?>" name="nama" class="form-control">
</div>
<div class="col-md-12">
<label for="inputState" class="form-label">NIP/NIDN</label>
<input id="nip" name="nip" value="<?php echo $row['nip_nidn']; ?>" class="form-control">
</div>
<div class="col-md-12">
<label for="inputState" class="form-label">Password</label>
<input id="Password" name="password" type="password" value="<?php echo $row['password']; ?>" class="form-control">
