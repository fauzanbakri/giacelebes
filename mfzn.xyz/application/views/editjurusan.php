...
<h1 class="mb-0 pb-0 display-4">Edit Jurusan</h1>
...
<div class="card mb-5">
<div class="card-body">
<form class="row g-3" action="EditJurusan/input" method="post">
<div class="col-md-12">
<label for="inputState" class="form-label">Jurusan</label>
<input name="jurusan" value="<?php echo $row['nama_jurusan']; ?>" class="form-control">
