      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" <?php echo $hide1;?>>
            <a href="add_new.php" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="add_action.php" id="quickForm">
                <div class="card-body">
                ...
                <!-- /.card-body -->
                <div class="card-footer">
                  <button id="sbm" type="submit" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
